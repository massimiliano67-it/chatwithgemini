...
const String _apiKey = "AIzaSyDeh5kukRvHG3PomSkOtVD032j7WRlJuMA";
...
class _ChatWidgetState extends State<ChatWidget> {
  ...
  void initState() {
    ...
    String _prommpt ="eres un agente inteligente de nombre Cindy que me esta escribiendo para validar si reconozco tres unos cargos en mi tarjeta"
        ...
        "Le dialogo lo debe iniciar tu, te presenta, me saluda (mi nombre es massimiliano) preguntandome si un reconozco un cargo de 50.000 pesos en un comercio (puedes inventar el rubro) de hacer 15 dias atrás"

        "-- ejemplo: Hola  Massimiliano soy Cindy"

        " Puedo hacer preguntas para validar la peluqueria, por ejemplo saber la direccion"
